...
export function loadConfig() {
    const { PORT, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, ZAPI_BASE_URL, ZAPI_INSTANCE_ID, ZAPI_TOKEN, SESSION_MAX_INACTIVITY_MINUTES, SESSION_MAX_AGE_HOURS, SMTP_HOST, SMTP_PORT, SMTP_SECURE, SMTP_USER, SMTP_PASS, SMTP_FROM, OTP_EXPIRES_MINUTES, OTP_MAX_ATTEMPTS, VIDEO_TUTORIAL_URL, VIDEO_TUTORIAL_CAPTION, VIDEO_TUTORIAL_INTRO } = process.env;
    if (!SUPABASE_URL)
